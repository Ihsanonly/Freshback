        ...
        <button class="theme-toggle" type="button" aria-label="Ganti mode tampilan" title="Ganti mode tampilan"><span aria-hidden="true">&#9789;</span></button>
            ...
            <header>
                <div>
                    ...
                    <p class="muted">
                        Perbarui data {{ $food->name }}. Insight akan dihitung ulang otomatis.
                    </p>
                </div>
            ...
            <div class="form-shell">
                ...
                >
                    ...
                    <div class="field form-row">
                        ...
                        <input
                            ...
                            name="purchase_date"
                            type="date"
                            value="{{ old('purchase_date', $food->purchase_date?->format('Y-m-d')) }}"
                        >
                    ...
                    <div class="field form-row">
                        ...
                        <input
                            ...
                            type="number"
                            min="1"
                            value="{{ old('shelf_life_days', $food->shelf_life_days) }}"
                        >
                    ...
                    <div class="field form-row">
                        ...
                        >
                            ...
                            @foreach ($categories as $category)
                                <option
                                    value="{{ $category }}"
                                    @selected(old('category', $food->category) === $category)
                                >
                                    {{ $category }}
                                </option>
                            @endforeach
                ...
                <aside>
                    ...
                    <div class="auto-note">
                        ...
                        <p>
                            Catatan tidak perlu diubah manual.
                            Saat tanggal atau masa simpan berubah,
                            FRESHBACK akan menghitung ulang kondisi makanan.
                        </p>
                    </div>
